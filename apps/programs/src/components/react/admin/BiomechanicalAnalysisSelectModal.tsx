 ...
 *
 * Modal for selecting an exercise to pull Biomechanical Analysis from.
...
import type { BiomechanicalAnalysisCandidate } from '@/lib/supabase/client/generated-exercises';

interface BiomechanicalAnalysisSelectModalProps {
  isOpen: boolean;
  onClose: () => void;
  /** Search results: exercises with Biomechanical Analysis to choose from */
  candidates: BiomechanicalAnalysisCandidate[];
  /** Called when admin selects an exercise */
  onSelect: (candidate: BiomechanicalAnalysisCandidate) => void;
  /** Optional: re-run search with same query (e.g. after data refresh) */
  onSearchAgain?: () => void;
  isSearchingAgain?: boolean;
}

const BiomechanicalAnalysisSelectModal: React.FC<BiomechanicalAnalysisSelectModalProps> = ({
  isOpen,
  onClose,
  candidates,
  onSelect,
        ...
        >
          <div className="flex items-center justify-between border-b border-white/10 p-6">
            <h2 className="font-heading text-xl font-bold text-white">
              Select exercise to pull Biomechanical Analysis from
            </h2>
            <button
              type="button"
              onClick={onClose}
...
export default BiomechanicalAnalysisSelectModal;
