  ...
  const handleBatchGenerate = async () => {
    ...
    for (let i = 0; i < topics.length; i++) {
      ...
      try {
        ...
        const sources = transformSearchResultsToSources(data.searchResults ?? [], topic);
              ...
              <details className="group rounded-lg border border-white/10 bg-black/20">
                ...
                <div className="space-y-3 border-t border-white/10 px-4 py-3">
                  <p className="text-xs text-white/60">
                    One exercise topic per line. Uses current form settings (complexity, style,
                    etc.).
                  </p>
                  <textarea
                    ...
                    className="w-full rounded-lg border border-white/10 bg-black/20 px-4 py-2 text-white placeholder:text-white/40 focus:border-[#ffbf00]/50 focus:outline-none focus:ring-2 focus:ring-[#ffbf00]/20 disabled:opacity-60"
                  />
                  {batchRunning && (
                  ...
                  <button
                    ...
                    className="rounded-lg border border-[#ffbf00]/50 bg-[#ffbf00]/10 px-4 py-2 text-sm font-medium text-white hover:bg-[#ffbf00]/20 disabled:cursor-not-allowed disabled:opacity-50"
                  >
          ...
          <div className="animate-fade-in space-y-6">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <div>
                ...
                {(res.imagePrompt || (res.imagePrompts && res.imagePrompts.length === 3)) && (
